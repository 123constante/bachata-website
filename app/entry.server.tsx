...
// (e.g. the intentional fetchQuery gate in routes/home.tsx). Emitting a single
// structured line routes them into Vercel function logs, keyed to the route +
// release, so a bad SSR path is diagnosable. Request-aborted errors (client
// navigated away / streamTimeout) are not bugs.
export function handleError(
  ...
  // Structured line → Vercel function logs.
  console.error(
    JSON.stringify({
      tag: "ssr-error",
      release: RELEASE_ID,
