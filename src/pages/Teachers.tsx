...
import { 
  Heart, Music, Star, Sparkles, GraduationCap
} from 'lucide-react';
...
const heroWidgets = [
  { emoji: "\u{1F50D}", title: "Find A Teacher", desc: "Browse directory", sectionId: "directory" },
  { emoji: "\u{270D}\u{FE0F}", title: "Get Listed", desc: "Join as teacher", sectionId: "get-listed" },
];
...
const Teachers = () => {
  ...
  // Fetch teachers from entities table
  const { data: teachers, isLoading } = useQuery({
    queryKey: ['teacher-entities'],
    queryFn: async () => {
    ...
    <div className="min-h-screen text-foreground overflow-x-hidden pb-20">
      ...
      <section className="pt-20 pb-24 px-4 relative overflow-hidden mb-12">
        ...
        <div className="relative z-10">
          <PageBreadcrumb items={[{ label: 'Classes', path: '/classes' }, { label: 'Teachers' }]} />
        </div>

        {/* Floating Icons */}
        {[GraduationCap, Star, Heart, Music, Sparkles].map((Icon, i) => (
          <motion.div
            key={i}
        ...
        <ScrollReveal animation="fadeUp">
          <Card className="bg-gradient-to-br from-primary/20 via-festival-purple/10 to-festival-pink/20 border-primary/30 p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Join our teacher directory and reach more students</p>
            </div>
            ...
            {isSubmitted ? (
              ...
              >
                <span className="text-6xl block mb-4">{'\u1F389'}</span>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                />
                <Input
                  placeholder="Specialty (e.g., Sensual Bachata) *"
