...
const DJProfile = () => {
  ...
  // Fetch DJ entity from entities table
    ...
    return (
      <div className="min-h-screen pt-20 px-4 pb-24">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-2xl font-bold text-foreground mb-4">DJ Not Found</h1>
          <p className="text-muted-foreground mb-6">The DJ profile you're looking for doesn't exist.</p>
        ...
        <ScrollReveal animation="fadeUp">
          <div className="flex flex-col sm:flex-row items-start gap-6 mb-8">
            ...
            <div className="flex-1">
              ...
              {/* Subheading: DJ */}
              <p className="text-muted-foreground text-lg">DJ</p>
