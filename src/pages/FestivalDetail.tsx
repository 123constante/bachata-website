...
.cinematic-festival .o-avatar::after{content:'★';position:absolute;bottom:-2px;right:-2px;width:24px;height:24px;background:#fb923c;color:#000;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;border:3px solid #0a0a0a;font-family:'Bebas Neue',sans-serif}
...
.cinematic-festival .tix .p::before{content:'£';color:#fb923c;font-size:0.6em;margin-right:2px}
    ...
    <div className="cinematic-festival min-h-screen pb-24 pt-20">
      ...
      <section className="hero">
        ...
        {festivalDetail?.identity.edition && (
          <div className="hero-tag">— {festivalDetail.identity.edition.toUpperCase()} —</div>
        )}
          ...
          <div className="hero-dates">
            ...
            {typeof monthLabel === "object" && (
              <div className="date-month">
                <b>{monthLabel.month}</b> · {monthLabel.year}
              </div>
            )}
          </div>
        )}
      ...
      {teachers.length > 0 && (
        <section className="lineup">
          ...
          <div className="sub">Reel 01 · {teachers.length} {teachers.length === 1 ? "Frame" : "Frames"}</div>
        ...
        <section className="program">
          <div className="program-wrap">
            <div className="section-h">
              ...
              <h2>The Schedule.</h2>
              <div className="sub">{days.length} {days.length === 1 ? "Day" : "Days"} · {festivalDetail?.schedule.length ?? 0} Sessions</div>
            </div>
      ...
      <section className="vo">
        <div className="vo-wrap">
          <div className="vo-grid">
            ...
            {organiser && (
              <div className="vo-col">
                <div className="section-h"><div className="lab">— THE ORGANISER —</div></div>
      ...
      {fullDescription && (
        <section className="about">
          <div className="about-wrap">
            <div className="about-label">— About the festival —</div>
      ...
      <footer>
        <div className="x">— {organiser?.displayName ?? "Festival"} · {festival.name} —</div>
      </footer>
