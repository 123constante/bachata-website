 ...
 * P5-native `get_public_festivals_list_v1` RPC (see the admin repo's migration
 * 20260717090000_public_festivals_list_v1.sql).
 *
...
export async function fetchPublicFestivalsList(): Promise<FestivalListItem[]> {
