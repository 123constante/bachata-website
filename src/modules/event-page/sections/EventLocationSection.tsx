  ...
  return (
    <section>
      <a
        ...
        className="block rounded-2xl border border-white/10 bg-white/[0.04] p-4 shadow-[0_10px_35px_rgba(0,0,0,0.28)] backdrop-blur-sm hover:border-white/20 hover:bg-white/[0.06] transition-all active:scale-[0.98]"
      >
