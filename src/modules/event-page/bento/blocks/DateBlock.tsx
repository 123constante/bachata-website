      ...
      {label ? (
        <div className="flex flex-1 flex-col justify-center">
          ...
          {label.isMultiDay && label.endDay && (
            <div className="mt-[2px] font-mono text-[9px] uppercase tracking-[0.14em] text-white/70">
        ...
        <div className="flex flex-1 items-center justify-center text-[11px] text-white/60">
          TBA
        </div>
      )}
    </BentoTile>
