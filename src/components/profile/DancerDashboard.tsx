...
export const DancerDashboard = () => {
  ...
  const groupedModules: ModuleSlot[] = [
    ...
    },
    {
      tab: 'overview',
      title: 'Next event',
      description: nextEvent?.name ? `${nextEvent.name}${nextEventLabel ? ` • ${nextEventLabel}` : ''}` : 'No upcoming event yet.',
      colSpan: '6',
    ...
    },
    {
      ...
      description: `${eventCounts.going} going • ${eventCounts.interested} interested`,
      colSpan: '12',
    ...
    },
    {
      ...
      description: normalizePartnerRole(dancerProfile.partner_role) ? `${normalizePartnerRole(dancerProfile.partner_role)} • ${dancerProfile.favorite_styles?.slice(0, 2).join(', ') || 'No styles set'}` : 'Set role and styles.',
      colSpan: '8',
          ...
          <Card className="dashboard-card border-festival-teal/35 shadow-md">
            <CardContent className="p-3 space-y-2">
              ...
              <p className="text-[11px] text-muted-foreground line-clamp-1">
                Name: {fullName || 'Not set'} • City: {dancerProfile.city || 'Not set'}
              </p>
              <p className="text-[11px] text-muted-foreground line-clamp-1">
