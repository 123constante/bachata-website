...
export const DayDetailModal = ({
  ...
  return (
    ...
    >
      <DialogContent className="max-w-md w-full h-[85svh] sm:h-[90svh] max-h-[90svh] p-0 gap-0 overflow-hidden bg-zinc-900 border-white/10 sm:rounded-3xl rounded-t-[32px] flex flex-col shadow-2xl [&>button]:hidden top-auto bottom-0 translate-y-0">
